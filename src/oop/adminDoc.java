 ...
 * @author A.I.S PERERA
 */
public class adminDoc extends javax.swing.JFrame {
    ...
    public void setRecordsToTable(){
        ...
        while (rs.next()){
            ...
            String arTime=rs.getString("Arriving_time");
            String spec=rs.getString("Specialization");
            

            String tbData[]={id,uName,password,FName,pno,emaiil,arTime,spec};
    ...
    private void initComponents() {
        ...
        arTime = new javax.swing.JTextField();
        ...
        nametext1.setText("Arriving Time");

        arTime.setFont(new java.awt.Font("Lexend Deca", 0, 12)); // NOI18N

        nametext3.setFont(new java.awt.Font("Lexend Deca Light", 0, 14)); // NOI18N
        nametext3.setForeground(new java.awt.Color(23, 107, 135));
        nametext3.setText("Specialization");
        ...
        spec.setFont(new java.awt.Font("Lexend Deca", 0, 12)); // NOI18N
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(nametext1)
                    .addComponent(arTime, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nametext4)
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "User Name", "Password", "Full Name", "Phone Number", "Email", "Arriving Time", "Specialization"
            }
        ) {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/oopproject","root","");
            Statement stmt=con.createStatement();
            stmt.execute("INSERT INTO doctor (User_name,Password,Full_name,Phone_number,Email,Arriving_time,Specialization) VALUES ('"+Uname.getText()+"','"+pw.getText()+"','"+FName.getText()+"','"+phoneNo.getText()+"','"+email.getText()+"','"+arTime.getText()+"','"+spec.getText()+"')");
 ...
 public int id;
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        arTime.setText(table.getValueAt(table.getSelectedRow(), 6).toString());
        spec.setText(table.getValueAt(table.getSelectedRow(), 7).toString());
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(n==0){
            stmt.execute("DELETE FROM doctor WHERE D_id ="+id);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/oopproject","root","");
            Statement stmt=con.createStatement();
            stmt.execute("UPDATE doctor SET User_name='"+Uname.getText()+"',Password='"+pw.getText()+"',Full_name='"+FName.getText()+"',Phone_number='"+phoneNo.getText()+"',Email='"+email.getText()+"',Arriving_time='"+arTime.getText()+"',Specialization='"+spec.getText()+"'"
                    + "WHERE D_id ="+id);
            formWindowOpened(null);
    ...
    private javax.swing.JTextField arTime;
