 ...
 * @author A.I.S PERERA
 */
public class adminRecep extends javax.swing.JFrame {
    ...
    public void setRecordsToTable(){
        ...
        while (rs.next()){
            ...
            String id=String.valueOf(rs.getInt("R_id"));
            ...
            String tbData[]={id,uName,password,FName,pno,emaiil,nic,add};
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "User Name", "Password", "Full Name", "Phone Number", "Email", "NIC", "Address"
            }
        ) {
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/oopproject","root","");
            Statement stmt=con.createStatement();
            stmt.execute("INSERT INTO receptionist (User_name,Password,Full_name,Phone_number,Email,NIC,Address) VALUES ('"+Uname.getText()+"','"+pw.getText()+"','"+FName.getText()+"','"+phoneNo.getText()+"','"+email.getText()+"','"+nic.getText()+"','"+address.getText()+"')");
 ...
 public int id;
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(n==0){
            stmt.execute("DELETE FROM receptionist WHERE R_id ="+id);
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try{
            ...
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/oopproject","root","");
            Statement stmt=con.createStatement();
            stmt.execute("UPDATE receptionist SET User_name='"+Uname.getText()+"',Password='"+pw.getText()+"',Full_name='"+FName.getText()+"',Phone_number='"+phoneNo.getText()+"',Email='"+email.getText()+"',NIC='"+nic.getText()+"',Address='"+address.getText()+"'"
                    + "WHERE R_id ="+id);
            formWindowOpened(null);
