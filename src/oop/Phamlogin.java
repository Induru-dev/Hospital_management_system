 ...
 * @author A.I.S PERERA
 */
public class Phamlogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginlext.setText("LOGIN AS PHARMACIST");
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        try{
         Class.forName("com.mysql.jdbc.Driver");
            ...
            String sql="SELECT*FROM pharmacist WHERE User_name='"+username.getText()+"' AND Password='"+password.getText()+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Phamlogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
