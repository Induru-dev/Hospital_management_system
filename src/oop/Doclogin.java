...
public class Doclogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        loginlext.setText("LOGIN AS DOCTOR");
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        try{
            ...
            String sql="SELECT*FROM doctor WHERE User_name='"+username.getText()+"' AND Password='"+password.getText()+"'";
            ResultSet rs=stmt.executeQuery(sql);

            if(rs.next()){
            DoctorCon dc=new DoctorCon();
            dc.docname.setText(rs.getString("Full_name"));
            dc.setVisible(true);
            dispose();
            }
            else{
